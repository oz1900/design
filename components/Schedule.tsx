...
export default function Schedule() {
  ...
  const slotsLabel = selected
    ? `Available times · ${DOW[new Date(year, month, selected).getDay()].charAt(0) + DOW[new Date(year, month, selected).getDay()].slice(1).toLowerCase()}, ${MONTH_NAMES[month]} ${selected}`
    : "Available times — select a date";

  const confirmText = selected && selectedSlot
    ? `${DOW[new Date(year, month, selected).getDay()].charAt(0) + DOW[new Date(year, month, selected).getDay()].slice(1).toLowerCase()}, ${MONTH_NAMES[month]} ${selected} · ${selectedSlot} CDT`
    ...
    <>
      <style>{`
        ...
        .cal-dow {
          ...
          padding: 8px 0; font-weight: 600; letter-spacing: 0.04em; text-transform: uppercase;
        }
        .cal-day {
        ...
        <div className="container">
          ...
          <div className="schedule-card" ref={cardRef}>
            ...
            <div className="sched-left">
              ...
              <p className="sched-meta-desc">
                Share a few details about your project — scope, location, timing, and the kind of support you need. We'll come prepared.
              </p>
            </div>
            ...
            <div className="sched-right">
              ...
              <div className="cal-grid">
                ...
                {Array.from({ length: firstDay }, (_, i) => (
                  <div key={`empty-${i}`} className="cal-day" style={{ cursor: "default" }} />
                ))}
                {Array.from({ length: daysInMonth }, (_, i) => {
                  ...
                  return (
                    <button
                      ...
                      disabled={!isClickable && !(d === TODAY && isMayDemo)}
              ...
              <div className="sched-confirm">
                ...
                <a href="mailto:Vitaliy@GreenbergSafety.com" className="btn btn-primary btn-sm">
                  Book a consultation
